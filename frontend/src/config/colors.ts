// Daruka Interview Bot — Color Palette
// Section 1.4 of the Master Plan — use ONLY these values throughout the app.
export const C = {
  primary: '#1A3A5C',   // Dark Navy  — headings, sidebar, primary buttons
  accent: '#2980B9',   // Blue       — links, highlights, active states
  light: '#b5d3e8ff',   // Light Blue — card backgrounds, hover fills
